...
function Index() {
  ...
  const { activeAcademyYear, setActiveAcademyYear } =
    useContext<any>(AcademicYearContext);
  ...
  const handleRejected = () => {
    schoolRejectTeachersRequest(selectedId)
      .then((res: any) => {
        if (res.ok) {
  ...
  const handleAccepted = () => {
    schoolAcceptTeachersRequest(selectedId)
      .then((res: any) => {
        if (res.ok) {
          toast.success(res.data.message, {
            pauseOnHover: false,
          ...
          <div className="data-table">
            <div className="top">
              ...
              <div className="span">
                <select
                  ...
                  id=""
                  onChange={(e: any) => null}
                  className="select-field school-student-select"
                >
            ...
            <div className="table-con">
              ...
              <table>
                <thead>
                  <tr>
                    {rows.map((row: any, index: any) => (
                      <th key={index} className={row.name}>
                        {row.label}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                  {teachersRequests.map((data: any, index: any) => (
                    <tr key={index}>
                      ...
                      <td className="flex-start">
                        <p>
                          {data?.specialities?.map((sp: any) => `${sp.name},`)}
                        </p>
                      </td>

  ...
  resources: {
    en: {
      translation: {
        ...
        step_one_description:
          "Create an account as a teacher and login to get started",
        step_two_title: "Create your different classrooms",
        step_two_description:
          "Create different classrooms for different subjects",
        step_three_title: "Add Contents",
        step_three_description:
          "Upload contents under the different classrooms",
    ...
    fr: {
      translation: {
        ...
        step_one_description:
          "Créez un compte en tant qu'enseignant et connectez-vous pour commencer",
        step_two_title: "Créez vos différentes salles de classe",
        step_two_description:
          "Créez différentes salles de classe pour différentes matières",
        step_three_title: "Ajouter du contenu",
        step_three_description:
          "Télécharger du contenu sous les différentes salles de classe",
        ...
        password_length_error:
          "Le mot de passe doit avoir plus de 4 caractères",
